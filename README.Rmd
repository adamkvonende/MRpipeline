...
1.  P-value thresholding `p_thresh =` : select variants that are associated with the exposure below a certain P-value threshold (default = 5x10e-8)
...
about harmonisation[`here`](https://elifesciences.org/articles/34408).
...
forward strand as the reverse strand (e.g. C/G on forward and G/C on reverse). You can read more about palindromic variants and the options the function has for dealing with them [here](PALINDROMES.md).
